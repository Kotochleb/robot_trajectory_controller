#ifndef __MPC_ROBOT_CONTROLLER__UTILS_HPP__
#define __MPC_ROBOT_CONTROLLER__UTILS_HPP__
...
nav_msgs::msg::Path MPCRobotController::transformGlobalPlan(
...
bool MPCRobotController::transformPose(const std::shared_ptr<tf2_ros::Buffer> tf,
