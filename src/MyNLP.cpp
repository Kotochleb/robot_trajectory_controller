...
bool MyNLP::get_bounds_info(Index n, Number* x_l, Number* x_u, Index m,
...
bool MyNLP::get_starting_point(Index n, bool init_x, Number* x, bool init_z,
...
bool MyNLP::eval_h(Index n, const Number* x, bool new_x, Number obj_factor,
...
void MyNLP::finalize_solution(SolverReturn status, Index n, const Number* x,
